import { changeUserEmail } from "../../src/services/authService";
import User from "../../src/models/User";
import bcrypt from "bcrypt";
import jwt from "jsonwebtoken";
import { sendUserActivationEmail } from "../../src/services/emailService";
...
describe("changeUserEmail", () => {
  ...
  it("devrait changer l'email et envoyer un mail d'activation", async () => {
    ...
    expect(sendUserActivationEmail).toHaveBeenCalledWith(newEmail, "faketoken");
  });
