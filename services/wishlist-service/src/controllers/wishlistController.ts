...
export const getMyWishesFromWishlist = asyncHandler(
  async (req: AuthenticatedRequest, res, next) => {
    ...
    if (!wishlist) {
      return next(new AuthError("Vous n'avez pas accès à cette wishlist."));
    }
...
export const getMyWish = asyncHandler(
  async (req: AuthenticatedRequest, res, next) => {
    ...
    if (!wishlist)
      return next(
        new AuthError("Vous n'avez pas le droit de consulter ce souhait.")
      );
...
export const updateWish = asyncHandler(
  async (req: AuthenticatedRequest, res, next) => {
    ...
    if (!wishlist)
      return next(
        new AuthError("Vous n'avez pas le droit de modifier ce souhait.")
      );
...
export const deleteWish = asyncHandler(
  async (req: AuthenticatedRequest, res, next) => {
    ...
    if (!wishlist)
      return next(
        new AuthError("Vous n'avez pas le droit de supprimer ce souhait.")
      );
