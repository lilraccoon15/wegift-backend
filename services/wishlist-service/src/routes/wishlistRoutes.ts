...
import { createWish, createWishlist, deleteWish, deleteWishlist, getUserWish, getUserWishesFromWishlist, getUserWishlist, getUserWishlists, updateWish, updateWishlist } from "../controllers/wishlistController";
